...
- token、FCM 凭证、邀请 secret、消息正文和文件内容不得写入日志、埋点或源码。
- Android 是当前唯一交付平台；iOS 代码、证书和验收不纳入本仓目标。
- 原生通知使用 FCM；ntfy 只在迁移窗口由主仓兼容，不在移动端新增依赖。
