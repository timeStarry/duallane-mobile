...
export const syntheticConversations: Conversation[] = [
  {
    ...
    capabilities: { canSendMessage: true, canUploadFile: true, canManageMembers: false },
  },
  {
    id: 'c-group',
  ...
  },
  {
    ...
    members: syntheticMembers,
    capabilities: { canSendMessage: false, canUploadFile: false, canManageMembers: false },
  },
];
