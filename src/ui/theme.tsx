...
export function ThemeProvider({mode,children}:{mode:'system'|'light'|'dark';children:React.ReactNode}){const system=useColorScheme();return <Theme.Provider value={palettes[mode==='system'?(system??'light'):mode]}>{children}</Theme.Provider>;}
